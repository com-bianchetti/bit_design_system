...
Features:
- Numeric keyboard type for easy number entry (or a dedicated large virtual keyboard for `VitCurrencyField`)
...
- Localized thousands separators and currency formatting
